# EXCLUSIVECOIN VANITY ADDRESS GENERATOR

1. `git clone https://github.com/Stoner19/exclusivecoin-vanitygen.git`
2. `cd exclusivecoin-vanitygen/`
3. `make`
4. `./vanitygen -E <string that starts with "E" here>`
